...
class BloggerConnector:
    ...
    def __init__(self, target_blog_id):
        ...
        # Get a request token.
        request_token = self.client.get_oauth_token(
            scopes=['http://www.blogger.com/feeds/'], 'http://gauthmachine.appspot.com/oauth', self.consumer_key,
        ...
        self.client.auth_token = client.get_access_token(request_token)
    ...
    def run(self):
        ...
        """
sample = BloggerConnector('8389298632417882839')
sample.run()
