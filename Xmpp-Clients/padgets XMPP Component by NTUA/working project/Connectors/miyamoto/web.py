...
class MiyamotoResource(Resource):
    ...
    def index(self):
        ...
        print "Something is not working here! Right?"
        ...
        print "Kai twra logika tha ton pioume!"
    ...
    def setup(cls):
        ...
        #r.putChild('index.html', static.File(sibpath(__file__, 'template/index.html')))
        return r
