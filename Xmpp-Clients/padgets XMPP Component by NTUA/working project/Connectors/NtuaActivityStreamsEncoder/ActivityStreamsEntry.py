...
class ActivityStreamsEntry:
    ...
    def addTargetPlatform( self, platform_name=None,account_email=None, account_username=None, account_uri=None,pages=None, is_final_platform=False):
